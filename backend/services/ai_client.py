...
class KimiProvider:
    ...
    def __init__(self, api_key: str) -> None:
        ...
        self._is_anthropic_compat = api_key.startswith("sk-kimi-")
...
def get_provider() -> ClaudeCodeProvider | ClaudeProvider | KimiProvider:
    from backend.config import AI_PROVIDER, CLAUDE_API_KEY, KIMI_API_KEY
